  ...
  return (
    <div className="grid gap-8">
      ...
      <div className="bg-gray-light">
        ...
        <div className="grid px-8 py-4 text-center border-t gap-y-4 gap-x-8">
          ...
          >
            ...
            <p>
              Please place your order before 10am the day prior to delivery.
            </p>
          </button>
          <button
            type="button"
        ...
        (deliveryArea === 'PORT_MACQUARIE' ||
          ...
          <div className="bg-gray-light">
            ...
            <div className="grid px-8 py-4 text-center border-t gap-y-4 gap-x-8">
              <button
                type="button"
                onClick={() => setDeliveryDate('MONDAY')}
                className={`p-4 border rounded transition duration-150 ease-in-out ${
                  deliveryDate === 'MONDAY'
                    ? 'bg-green-dark text-white'
                    : 'bg-white hover:border-green-dark'
              ...
              <button
                type="button"
                onClick={() => setDeliveryDate('TUESDAY')}
                className={`p-4 border rounded transition duration-150 ease-in-out ${
              ...
              <button
                type="button"
                onClick={() => setDeliveryDate('WEDNESDAY')}
                className={`p-4 border rounded transition duration-150 ease-in-out ${
              ...
              <button
                type="button"
                onClick={() => setDeliveryDate('THURSDAY')}
                className={`p-4 border rounded transition duration-150 ease-in-out ${
              ...
              <button
                type="button"
                onClick={() => setDeliveryDate('FRIDAY')}
                className={`p-4 border rounded transition duration-150 ease-in-out ${
                  deliveryDate === 'FRIDAY'
                    ? 'bg-green-dark text-white'
                    : 'bg-white hover:border-green-dark'
      ...
      <div className="flex justify-between mt-16">
        ...
        {((active === 'PICKUP' && deliveryArea !== '' && deliveryDate !== '') ||
          (active === 'DELIVERY' && deliveryArea !== '')) && (
          <button
            type="button"
            onClick={nextStep}
            className="inline-flex items-center space-x-2 cta text-green-dark bg-yellow"
